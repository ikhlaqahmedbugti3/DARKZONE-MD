...
module.exports = {
    // ===== BOT CORE SETTINGS =====
    SESSION_ID: process.env.SESSION_ID || "IK~m1B2SSAS#sEjp0meZ6LhghKeBdjxXIWKb8nbcsWJp79KLxD-QaFg",  // Your bot's session ID (keep it secure)
    ...
    OWNER_NAME: process.env.OWNER_NAME || getConfig("OWNER_NAME") || "IKHLAQ AHMED",           // Owner's name
    DEV: process.env.DEV || "923334104708",                     // Developer's contact number
    DEVELOPER_NUMBER: '923334104708@s.whatsapp.net',            // Developer's WhatsApp ID
    ...
    STICKER_NAME: process.env.STICKER_NAME || "IKHL𝒜Q 𝒜𝐻𝑀𝒜𝒟",     // Sticker pack name
    ...
    DESCRIPTION: process.env.DESCRIPTION || "*© CREATER IKHL𝒜Q 𝒜𝐻𝑀𝒜𝒟*",  // Bot description
